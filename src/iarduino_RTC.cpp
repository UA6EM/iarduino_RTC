...
void		iarduino_RTC::I2C_func_START			() {uint16_t I2C_var_I=0; I2C_mass_STATUS[2]=1; TWCR = _BV(TWINT) | _BV(TWEN) | _BV(TWSTA); while(!(TWCR & _BV(TWINT))){I2C_var_I++; if(I2C_var_I>I2C_mass_STATUS[1]){I2C_mass_STATUS[2]=0; break;}} I2C_mass_STATUS[3] = TWSR & 0xF8; if(I2C_mass_STATUS[3]!=0x08){I2C_mass_STATUS[2]=0;}}
void		iarduino_RTC::I2C_func_RESTART			() {uint16_t I2C_var_I=0;if(I2C_mass_STATUS[2]){ TWCR = _BV(TWINT) | _BV(TWEN) | _BV(TWSTA); while(!(TWCR & _BV(TWINT))){I2C_var_I++; if(I2C_var_I>I2C_mass_STATUS[1]){I2C_mass_STATUS[2]=0; break;}} I2C_mass_STATUS[3] = TWSR & 0xF8; if(I2C_mass_STATUS[3]!=0x10){I2C_mass_STATUS[2]=0;}}}
void		iarduino_RTC::I2C_func_SEND_ID			(uint8_t I2C_byte_ID, bool I2C_bit_RW)	{uint16_t I2C_var_I=0;if(I2C_mass_STATUS[2]){ TWDR = (I2C_byte_ID<<1)+I2C_bit_RW; TWCR = _BV(TWINT) | _BV(TWEN); while(!(TWCR & _BV(TWINT))){I2C_var_I++; if(I2C_var_I>I2C_mass_STATUS[1]){I2C_mass_STATUS[2]=0; break;}} I2C_mass_STATUS[3] = TWSR & 0xF8; if(I2C_bit_RW){ if(I2C_mass_STATUS[3]!=0x40){I2C_mass_STATUS[2]=0;}}else{if(I2C_mass_STATUS[3]!=0x18){I2C_mass_STATUS[2]=0;}}}}
void		iarduino_RTC::I2C_func_WRITE_BYTE		(uint8_t I2C_byte_DATA)	{uint16_t I2C_var_I=0;if(I2C_mass_STATUS[2]){ TWDR = I2C_byte_DATA; TWCR = _BV(TWINT) | _BV(TWEN); while(!(TWCR & _BV(TWINT))){I2C_var_I++; if(I2C_var_I>I2C_mass_STATUS[1]){I2C_mass_STATUS[2]=0; break;}} I2C_mass_STATUS[3] = TWSR & 0xF8; if(I2C_mass_STATUS[3]!=0x28){I2C_mass_STATUS[2]=0;}}}
uint8_t		iarduino_RTC::I2C_func_READ_BYTE		(bool I2C_bit_ACK) {uint16_t I2C_var_I=0;if(I2C_mass_STATUS[2]){ TWCR = _BV(TWINT) | _BV(TWEN) | I2C_bit_ACK<<TWEA; while(!(TWCR & _BV(TWINT))){I2C_var_I++; if(I2C_var_I>I2C_mass_STATUS[1]){I2C_mass_STATUS[2]=0; break;}} I2C_mass_STATUS[3] = TWSR & 0xF8; if(I2C_bit_ACK){if(I2C_mass_STATUS[3]!=0x50){I2C_mass_STATUS[2]=0;}}else{if(I2C_mass_STATUS[3]!=0x58){I2C_mass_STATUS[2]=0;}} return TWDR;}else{return 0xFF;}}
void		iarduino_RTC::I2C_func_STOP			() {uint16_t I2C_var_I=0; TWCR = _BV(TWINT) | _BV(TWEN) | _BV(TWSTO); while(!(TWCR & _BV(TWSTO))){I2C_var_I++; if(I2C_var_I>I2C_mass_STATUS[1]){I2C_mass_STATUS[2]=0; break;}} delayMicroseconds(20);}
...
uint8_t		iarduino_RTC::SPI_func_WRITEREAD_BYTE	(uint8_t SPI_byte_DATA)	{uint16_t SPI_var_I=0; SPI_mass_STATUS[2]=1; SPDR = SPI_byte_DATA; while(!(SPSR & _BV(SPIF))){SPI_var_I++; if(SPI_var_I>SPI_mass_STATUS[1]){SPI_mass_STATUS[2]=0; break;}} if(SPI_mass_STATUS[2]){return SPDR;}else{return 0xFF;}}
...
void		iarduino_RTC::SI3_func_begin			(uint8_t i, uint8_t j)	{SI3_mass_STATUS[2]=1; SI3_line_CLK=i; SI3_line_DAT=j; pinMode(SI3_line_DAT, INPUT); pinMode(SI3_line_CLK, OUTPUT); digitalWrite(SI3_line_CLK, (SI3_mass_STATUS[3] & _BV(1) ? HIGH:LOW));}
